<template>
  <view class="number-input">
    <view class="btn decrement" :class="{ disabled: isMin }" @click="decrement">-</view>
    ...
    <view class="btn increment" :class="{ disabled: isMax }" @click="increment">+</view>
  </view>
</template>
...
export default {
  ...
  methods: {
    ...
    handleChange(event) {
      console.log(event);
      const value = event.detail.value === "" ? 0 : Number(event.detail.value);
      this.setValue(value);
    },
