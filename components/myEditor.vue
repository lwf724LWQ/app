<template>
    <view class="editor" :class="{isReady:editorCtx}">
        <view class="toolbar" v-if="!props.readOnly">
            <view class="toolbar-btn" :class="{ active: modeConfig['bold'] }" @click="toggleTextMode('bold')">
                <text class="toolbar-icon bold">B</text>
            </view>
            <view class="toolbar-btn" :class="{ active: modeConfig['italic'] }" @click="toggleTextMode('italic')">
                <text class="toolbar-icon italic">I</text>
            </view>
            <view class="toolbar-btn" :class="{ active: modeConfig['underline'] }" @click="toggleTextMode('underline')">
                <text class="toolbar-icon underline">U</text>
            </view>
            <view class="toolbar-btn" :class="{ active: modeConfig['strike'] }" @click="toggleTextMode('strike')">
            ...
            <view class="toolbar-divider"></view>
            <view class="toolbar-btn color-btn" :class="{ active: modeConfig['color'] }" @click="toggleColor">
        ...
        <editor v-show="!props.readOnly" id="editor" class="ql-container" placeholder="开始输入..." show-img-size show-img-toolbar
            show-img-resize @statuschange="onStatusChange" :read-only="props.readOnly" @ready="onEditorReady"
            >
        </editor>
