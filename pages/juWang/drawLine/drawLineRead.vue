  ...
  <view class="container">
    ...
    <view class="numbers-table-container">
      <table class="numbers-table">
        ...
        <!-- 表格内容 -->
        <tbody>
        <tr v-for="(group, groupIndex) in classifyList" :key="group.qishu" class="table-row" :data-qishu="group.qishu"
        ...
        >
          ...
          >
            <view class="number-item"  :data-group-index="groupIndex"
                  :data-num-index="numIndex" ref="numberRefs">
              {{ num }}
            </view>
          </td>
        </tr>
...
/* 列宽定义 */
.col-def-1 { width: 120rpx; }
.col-def-2 { width: 60rpx; }
.col-def-3 { width: 90rpx; }
.col-def-4 { width: 90rpx; }
.col-def-5 { width: 90rpx; }
.col-def-6 { width: 90rpx; }
.col-def-7 { width: 60rpx; }
