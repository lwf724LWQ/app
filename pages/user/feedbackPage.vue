    ...
    <view class="feedback-page" :class="useOldManModeStore?.enabled ? 'old-man-mode' : ''">
        ...
        <view class="feedback-container">
            ...
            <view class="form-group">
                ...
                <view class="flex">
                    <label class="radio">
                        <radio value="r1" :checked="feedbackForm.type == '建议'" @click="feedbackForm.type = '建议'">建议
                        </radio>
                    </label>
                    <label class="radio">
                        <radio value="r2" :checked="feedbackForm.type == '投诉'" @click="feedbackForm.type = '投诉'" />投诉
                    </label>
                </view>
            </view>
            <!-- 标题 -->
            <view class="form-group">
                ...
                <input type="text" id="contactInfo" v-model="feedbackForm.title" placeholder="请输入标题"
                    class="form-control" />
            </view>
            ...
            <view class="form-group">
                ...
                <textarea id="feedbackContent" v-model="feedbackForm.content" placeholder="请输入您的反馈内容..." rows="5"
            ...
            <view class="form-group">
                ...
                <input type="text" id="contactInfo" v-model="feedbackForm.contact" placeholder="请输入邮箱或手机号（可选）"
                    class="form-control" />
            </view>
