    ...
    <view class="function-area">
      <view class="function-grid">
        ...
        <view class="icon-item" @click="drawGui">
          <uni-icons type="compose" size="40" color="#e74c3c"></uni-icons>
          <text>画规</text>
        </view>
        <view class="icon-item" @click="toChangtiao">
          <uni-icons type="bars" size="40" color="#e74c3c"></uni-icons>
          <text>长条</text>
        </view>
        ...
        <view class="icon-item" @click="goToLive">
          <uni-icons type="videocam" size="40" color="#e74c3c"></uni-icons>
          <text>开奖直播</text>
        </view>
        <!-- <view class="icon-item">
        ...
        <view class="icon-item" @click="goToDreamInterpretation">
          <uni-icons type="chat" size="40" color="#e74c3c"></uni-icons>
          <text>解梦</text>
        </view>
        <!-- <view class="icon-item">
        ...
        <view class="icon-item" @click="goToSearchuser">
          <uni-icons type="search" size="40" color="#e74c3c"></uni-icons>
          <text>彩友搜索</text>
        </view>
